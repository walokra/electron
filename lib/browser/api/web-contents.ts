...
for (const method of webFrameMethods) {
  WebContents.prototype[method] = function (...args: any[]): Promise<any> {
    return ipcMainUtils.invokeInWebContents(this, false, IPC_MESSAGES.INTERNAL_RENDERER_WEB_FRAME_METHOD, method, ...args);
  };
}
...
WebContents.prototype.executeJavaScript = async function (code, hasUserGesture) {
  ...
  return ipcMainUtils.invokeInWebContents(this, false, IPC_MESSAGES.INTERNAL_RENDERER_WEB_FRAME_METHOD, 'executeJavaScript', String(code), !!hasUserGesture);
};
WebContents.prototype.executeJavaScriptInIsolatedWorld = async function (worldId, code, hasUserGesture) {
  await waitTillCanExecuteJavaScript(this);
  return ipcMainUtils.invokeInWebContents(this, false, IPC_MESSAGES.INTERNAL_RENDERER_WEB_FRAME_METHOD, 'executeJavaScriptInIsolatedWorld', worldId, code, !!hasUserGesture);
};

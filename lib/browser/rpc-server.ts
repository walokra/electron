...
ipcMainInternal.on(IPC_MESSAGES.BROWSER_WINDOW_CLOSE, function (event: ElectronInternal.IpcMainInternalEvent) {
...
ipcMainInternal.handle(IPC_MESSAGES.BROWSER_GET_LAST_WEB_PREFERENCES, function (event: IpcMainInvokeEvent) {
...
ipcMainUtils.handleSync(IPC_MESSAGES.BROWSER_CLIPBOARD_SYNC, function (event: IpcMainInvokeEvent, method: string, ...args: any[]) {
...
if (BUILDFLAG(ENABLE_DESKTOP_CAPTURER)) {
  ...
  ipcMainInternal.handle(IPC_MESSAGES.DESKTOP_CAPTURER_GET_SOURCES, async function (event: IpcMainInvokeEvent, options: Electron.SourcesOptions, stack: string) {
...
ipcMainUtils.handleSync(IPC_MESSAGES.BROWSER_SANDBOX_LOAD, async function (event: IpcMainInvokeEvent) {
...
ipcMainInternal.on(IPC_MESSAGES.BROWSER_PRELOAD_ERROR, function (event: ElectronInternal.IpcMainInternalEvent, preloadPath: string, error: Error) {
...
ipcMainUtils.handleSync(IPC_MESSAGES.CRASH_REPORTER_SET_UPLOAD_TO_SERVER, (event: IpcMainInvokeEvent, uploadToServer: boolean) => {
